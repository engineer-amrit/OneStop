  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          'fixed top-26 left-1/2 z-50 -translate-x-1/2 rounded-xl',
...
const Loader = () => {
  return (
    <div className='rounded-xl border bg-background/95 backdrop-blur-lg supports-backdrop-filter:bg-background/60 w-56 h-10 flex items-center'>
      <BeatLoader size={20} color='#ffff' className="mx-auto" />
    </div>
  )
}
