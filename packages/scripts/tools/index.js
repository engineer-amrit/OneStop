...
async function runChanges(args2) {
...
var hasEnv = args.includes("-e") || args.includes("--env");
var hasChanges = args.includes("-c") || args.includes("--changes");
var hasTurboVersion = args.includes("-tv") || args.includes("--turbo-version");
